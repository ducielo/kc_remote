...
export const AdminDashboardModernized: React.FC<AdminDashboardProps> = ({ onClose }) => {
  ...
  // Hook pour le back-office (simplifié pour éviter les timeouts)
  const [backOfficeStatus, setBackOfficeStatus] = useState({ isInitialized: false, isLoading: false, error: null });
    ...
    <div className="space-y-6">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <Button 
                          ...
                          className="flex flex-col h-auto p-4 space-y-2"
                          onClick={() => {
                            toast.success('Interface utilisateurs ouverte');
                          }}
                        >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Outils de test et de debugging pour le système back-office
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case 'routes':
        return (
          <div className="p-6">
            <h2 className="text-xl font-bold mb-4">Gestion des Trajets</h2>
            <p className="text-gray-600">Interface de gestion des trajets en cours de développement...</p>
          </div>
        );
      case 'schedules':
        return (
          <div className="p-6">
            ...
            <p className="text-gray-600">Interface de gestion des horaires en cours de développement...</p>
          </div>
        );
      case 'tickets':
        return (
          <div className="p-6">
            <h2 className="text-xl font-bold mb-4">Gestion des Billets</h2>
            <p className="text-gray-600">Interface de gestion des billets en cours de développement...</p>
          </div>
        );
      case 'refunds':
        return (
          <div className="p-6">
            <h2 className="text-xl font-bold mb-4">Gestion des Remboursements</h2>
            <p className="text-gray-600">Interface de gestion des remboursements en cours de développement...</p>
          </div>
        );
      case 'content':
        return (
          <div className="p-6">
            <h2 className="text-xl font-bold mb-4">Gestion du Contenu</h2>
            <p className="text-gray-600">Interface de gestion du contenu en cours de développement...</p>
          </div>
        );
      case 'stats':
        return (
          <div className="p-6">
            ...
            <p className="text-gray-600">Interface des statistiques en cours de développement...</p>
          </div>
        );
      case 'users':
        return (
      ...
      case 'analytics':
        return (
          <div className="p-6">
            ...
            <p className="text-gray-600">Interface d'analytics en cours de développement...</p>
          </div>
        );
      case 'settings':
        return (
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Karis Continental - Contrôle total</p>
              </div>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <div className="text-right">
              ...
              <p className="text-xs text-gray-500">Droits complets</p>
            </div>
